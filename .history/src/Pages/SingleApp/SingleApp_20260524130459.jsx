...
const SingleApp = ({trendingApp}) => {
  ...
  <div className="$$card-body">
    ...
    <div className="$$card-actions justify-between p-4 flex">
      <div className="$$badge $$badge-outline flex gap-1 text-[#00D390] font-medium text-[16px] items-center bg-[#F1F5E8] rounded p-1"><span className=''><PiDownloadSimpleBold />
</span>{downloads}</div>
      <div className="$$badge $$badge-outline"><span></span>{ratingAvg}</div>
    </div>
  </div>
</div>
    );
