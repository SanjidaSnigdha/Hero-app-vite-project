...
const SingleApp = ({trendingApp}) => {
  ...
  <div class="$$card-body">
    ...
    <div class="$$card-actions justify-between p-4 flex">
      <div class="$$badge $$badge-outline flex gap-1 text-[#00D390] font-medium text-[16px] bg-[#F1F5E8] rounded p-1"><span className=''><PiDownloadSimpleBold />
</span>{downloads}</div>
      <div classN="$$badge $$badge-outline">{ratingAvg}</div>
    </div>
  </div>
</div>
    );
