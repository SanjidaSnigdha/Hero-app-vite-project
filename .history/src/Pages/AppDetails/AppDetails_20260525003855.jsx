    ...
    return (
        <div className='w-11/12 mx-auto mt-10'>
            ...
            <div className='flex justify-center items-center text-center font-extrabold text-[40px] text-[#001931] gap-30'>
             ...
             <button className='btn items-center gap-2 rounded bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-[#FFFFFF] mt- mb-5 justify-center'>Install Now <span>{(size)}</span></button>
