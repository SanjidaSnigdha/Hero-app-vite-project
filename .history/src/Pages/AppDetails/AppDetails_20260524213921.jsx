    ...
    return (
        <div className='w-11/12 mx-auto mt-10'>
            <div className='flex gap-8'>
                <img className='w-54 h-54rounded mt-10' src={image} alt=""/>
                <div>
             ...
             <p>Developed by <span className='bg-gradient-to-r from-[#632EEF] to-[#9F62F2] text-transparent bg-clip-text font-bold'>{companyName}</span></p>
               ...
               {/*  */}
                <div className='text-[#FFFFFF] items-center justify-center text-center'>
            ...
            <div className='flex justify-center items-center text-center font-extrabold text-[35px] text-[#001931] gap-25'>
                <h1>29.6M</h1>
                <h1>906K</h1>
                <h1>132+</h1>
            </div>
