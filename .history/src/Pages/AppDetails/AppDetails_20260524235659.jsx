             ...
             <p>Developed by <span className='bg-gradient-to-r from-[#632EEF] to-[#9F62F2] text-transparent bg-clip-text font-bold'>{companyName}</span></p>
               ...
               {/*  */}
                <div className='items-center justify-center text-center'>
                    <div className='flex justify-center items-center text-center gap-25 font-normal text-[16px]'>
                        <span className='text-gradient-to-r from-[#54CF68] to-[#00827A]'><PiDownloadSimpleBold />
                        </span>
