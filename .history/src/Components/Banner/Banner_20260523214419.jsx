...
const Banner = () => {
   ...
   <p className="text-[#627382] text-[20px] font-normal mt-">At HERO.IO , we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.<br />Our goal is to turn your ideas into digital experiences that truly make an impact. </p>
   <div className="flex items-center justify-center gap-2">
  <a
  href="https://play.google.com/store/apps/details?id=com.yourapp.package"
  target="_blank"
  rel="noopener noreferrer"
  className="btn flex items-center gap-2 rounded font-bold text-[#001931] p-2 mt-4"
>
...
<a
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="btn flex items-center gap-2 rounded text-[#001931 font-bold] mt-4 p-2"
>
