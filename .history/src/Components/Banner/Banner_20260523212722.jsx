...
const Banner = () => {
    return (
        <div className='justify-center items-center text-center flex flex-col mt-1 bg-gradient-to-r from-[#632EE3]/20 to-[#9F62F2]/90'>
  ...
  className="btn flex items-center gap-2 rounded bg-[#D2D2D2] text-[#001931]"
>
