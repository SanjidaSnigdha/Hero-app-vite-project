...
const TrustedPart = () => {
    return (
        <div className='w-full h-70 bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-[#FFFFFF] items-center justify-center text-center'>
            ...
            <div className='flex justify-center items-center text-center font-extrabold text-[64px] text-[#FFFFFF] gap-20'>
                <h1>29.6M</h1>
                <h1>906K</h1>
                <h1>132+</h1>
            </div>
